        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            <Card className="p-6 hover:shadow-[var(--shadow-soft)] transition-[var(--transition-smooth)]">
              ...
              <h3 className="text-xl font-semibold mb-2">1. Upload Sample</h3>
            ...
            <Card className="p-6 hover:shadow-[var(--shadow-soft)] transition-[var(--transition-smooth)]">
              ...
              <h3 className="text-xl font-semibold mb-2">2. Type Content</h3>
            ...
            <Card className="p-6 hover:shadow-[var(--shadow-soft)] transition-[var(--transition-smooth)]">
              ...
              <h3 className="text-xl font-semibold mb-2">3. Print</h3>
